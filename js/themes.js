...
let themeAssest = getComputedStyle(document.documentElement)
...
function loadTheme() {
  ...
  if (storedThemeMetaColor) {
    ...
    let documentTheme = document.querySelector("html").className;
    if (
      documentTheme.includes("light") &&
      !documentTheme.includes(storedThemeMetaColor)
    ) {
      document.querySelector(
        "html"
      ).className = `${storedThemeMetaColor} light`;
    } else if (
      documentTheme.includes("dark") &&
      !documentTheme.includes(storedThemeMetaColor)
    ) {
